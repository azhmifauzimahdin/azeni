      ...
      <div>
        {value ? (
          <Img
            ...
            alt="Foto"
            wrapperClassName="w-1/2 md:w-full aspect-[3/4] rounded overflow-hidden mb-3 mx-auto"
            sizes="300px"
          />
        ) : (
          <div className="w-1/2 md:w-full aspect-[3/4] rounded overflow-hidden mb-3 mx-auto flex-center border border-slate-300 text-slate-500 text-sm">
            Tanpa Foto
          </div>
        )}
